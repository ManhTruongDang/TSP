function [score] = tour_length(chromosome, city_list, iter_num, chromosome_id)
...
title(sprintf('Iteration %d, number %d, tour length %f', iter_num, chromosome_id, dist_tsp));
score = dist_tsp;
pause(1)
close
